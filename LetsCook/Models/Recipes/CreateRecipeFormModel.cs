namespace LetsCook.Models.Recipes
{
    ...
    public class CreateRecipeFormModel
    {
        ...
        [Range(RecipeTimeMinValue, RecipeTimeMaxValue, ErrorMessage = "{0} be between {1} and {2}")]
        ...
        [Display(Name = "Resting time (in minutes)")]
        ...
        public List<SubRecipeViewModel> SubRecipes { get; set; } = new List<SubRecipeViewModel>();
